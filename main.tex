...
\COMMENT{SD: ApJ at least uses backslash-nodata for empty entries in tables. AM: What does this entail for authors? Actual empty space, or something like ``N/A''?  SD: In the typeset table, the backslash-nodata entries appear as ellipsis.}
