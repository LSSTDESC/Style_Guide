...
\begin{itemize}
\item Cite software according to the journal's style; e.g., often this is done with a footnote providing the URL of the software's webpage or source code repository. DESC software should also be cited with a reference to the publication presenting it, where available. Note that the specific release (version) used by a given work should always be explicitly cited.
\end{itemize}
