...
\author{DESC Publication Board: Seth Digel$^1$ (Publication Manager), Pierre Astier,$^2$ David Kirkby,$^3$\\ Rachel Mandelbaum,$^4$ Adam Mantz,$^5$ Phil Marshall,$^1$ Hiranya Peiris,$^6$ and Michael Wood-Vasey$^7$
  \medskip\\
    {\small$^1$\slac}\\
    {\small$^2$}\\
    {\small$^3$}\\
