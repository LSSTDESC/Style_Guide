...
It is preferable to write the abstract as a single paragraph, if not using the ``traditional'' A\&A format.  Shorter is
...
f%irst six highlight differences between standard British and European usage.
