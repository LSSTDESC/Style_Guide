...
For simple shading, the same advice as for line and scatter plots applies. For more complex cases, e.g.\ parameter constrain plots where pairs of similar colors (for 1 and $2\sigma$ contours) are desired\ldots \FIXME{to be expanded}
