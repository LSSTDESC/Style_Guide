...
\verb|DESC\_macros.tex|, available <somewhere>.  To use, insert the line
\verb|\input DESC\_macros| after the initial \verb|\documentclass| command in your input
file.
...
{\Planck\ maps are in general ``pseudocolour'' maps, that is, they map
...
%
%\begin{enumerate}
%\item {\it File formats\/}.  Use graphics software that produces scaleable,
...
%
%
%\item {\it File sizes\/}.  Giant files are awkward to deal with, and may make
...
%\item {\it Bounding Boxes\/}.  If you are working with an EPS or PDF file,
...
%{The Python and IDL scripts described and used in Paperplots.pdf and found
%at \url{http://github.com/zonca/paperplots/} show how to do this.  As a last
...
both the quantity and the uncertainty.  
