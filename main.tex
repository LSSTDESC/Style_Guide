...
\section{Credit}
The LSST DESC Style Guide borrows extensively, with permission, from the ``Style Guide for {\it Planck} Papers," by C. R. Lawrence, 
T. J. Pearson, D. Scott, L. Spencer, and A. Zonca.\footnote{The \href{Planck Style Guide}{https://www.cosmos.esa.int/documents/387566/387653/Planck_Style_Guide.pdf} 
can be downloaded from the Planck Archive at \url{https://www.cosmos.esa.int/web/planck/publications}}
We are very grateful to these authors for allowing us to distribute our adaptation under the GPL 3.0 License.\footnote{A copy of the GPL 3 License may be obtained from this document's repository at \url{https://github.com/LSSTDESC/Style_Guide/blob/master/LICENSE}}
The \TeX\ source was provided to DESC by C. R. Lawrence and the La\TeX\ repository for the DESC Guide was developed by Adam Mantz.
