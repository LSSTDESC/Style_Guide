...
The \href{https://github.com/LSSTDESC/start_paper}{\tt start\_paper} project is intended to streamline the process of developing DESC papers and notes, in various formates (La\TeX, Jupyter notebook, \ldots). \FIXME{add details}
...
Any figures with color should use color combinations that are colorblind-friendly. \FIXME{More explicit guidance to be included here. For now, some links:}

A suggestion that was used in SDSS-IV and HSC: \url{https://jiffyclub.github.io/palettable/tableau/}. Look for the palette ColorBlind\_10, here is how to use it in python:
...
More color palette suggestions: \url{http://mkweb.bcgsc.ca/colorblind/}

A page with a longer narrative discussion about how to design figures for color blind people: \url{http://www.somersault1824.com/tips-for-designing-scientific-figures-for-color-blind-readers/}

Links to color blindness simulators, which let you select color palettes and/or upload figures and see what they would look like for people with various forms of color blindness
\begin{itemize}
