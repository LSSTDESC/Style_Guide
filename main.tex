...
\item{The first reference to the observatory by itself should be to the ``Vera C. Rubin Observatory".  Subsequent references should be either ``Rubin Observatory" or ``Rubin" (not VRO).}
