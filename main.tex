...
\author{DESC Publications Board: Seth Digel$^{1,2}$ (Publication Manager), Pierre Astier,$^{3,4,5}$ David Kirkby,$^6$\\ Rachel Mandelbaum,$^7$ Adam Mantz,$^{2,8}$ Phil Marshall,$^{1,2}$ Hiranya Peiris,$^9$ and Michael Wood-Vasey$^{10}$
  \medskip\\
  \begin{tabular}{l}
    {\small$^1$\slac}\\
    {\small$^2$\kipac}\\
