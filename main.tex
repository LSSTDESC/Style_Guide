...
The \href{https://github.com/LSSTDESC/start_paper}{\tt start\_paper} project is intended to streamline the process of developing DESC papers and notes, in various formats (La\TeX, Jupyter notebook, \ldots). \FIXME{add details}
...
Any figures with color should use color combinations that are colorblind-friendly.  Here are some
suggestions for color palettes that can be used when identifying different line colors or making
color maps:
\begin{itemize}
\item \url{https://jiffyclub.github.io/palettable/tableau/} palette ColorBlind\_10.  Here is an
  example python code snippet that shows how to use it:
\begin{verbatim}
...
\end{verbatim}
\item \url{http://mkweb.bcgsc.ca/colorblind/}
\end{itemize}

For those who want more information or ideas, a longer narrative discussion on how to design figures
for color blind people can be found at \\ \url{http://www.somersault1824.com/tips-for-designing-scientific-figures-for-color-blind-readers/}.

Finally, if you want to check how well you are doing, there are several online color blindness
simulators,  which let you select color palettes and/or upload figures and see what they would look
like for people with various forms of color blindness:
\begin{itemize}
\item \url{http://colororacle.org/}
\item \url{http://www.vischeck.com/vischeck/vischeckImage.php}
\item \url{http://www.color-blindness.com/coblis-color-blindness-simulator/}
\end{itemize}

For line plots, whenever practical, different line styles should be used to distinguish lines \emph{even if they are different colors}. Analogously, scatter plots should use different symbol shapes to distinguish data sets, even when they appear in different colors.
...
%map?} 
See Section~\ref{sec:figcolor} for some notes on how to make the map colorblind-friendly.
